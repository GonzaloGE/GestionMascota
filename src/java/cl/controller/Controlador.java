...
//        }
    ...
    protected void nuevoProducto(HttpServletRequest request, HttpServletResponse response)
        ...
        if (precio < 1) {
            request.setAttribute("msg", "Precio debe ser mayor a 0");
        } else if (unidad < 1) {

            request.setAttribute("msg", "Unidad debe ser mayor a 0");
    ...
    private void addusser(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (servicio.buscarUsuario(rut) == null) {
            ...
            newuser.setRutUser(rut);
            newuser.setNombreUser(nombre);
            newuser.setApellidoUser(apellido);
...
//        
            ...
            request.setAttribute("msg", "Rut ya registrado");
